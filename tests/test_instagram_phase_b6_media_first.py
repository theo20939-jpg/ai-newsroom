...
def test_v10_makes_generated_media_first_class_and_v91_is_untouched() -> None:
    ...
    assert cd.CAROUSEL_PROMPT_VERSION == "10" and "10" in cd.MEDIA_FIRST_CAROUSEL_VERSIONS and "10" in cd._EVIDENCE_HANDLE_CAROUSEL_VERSIONS
...
def _slide_dict(role, copy_text, source, regions, *, brief=None, family="light_utility_editorial", subject=None, **kw):
    ...
    base = {"role": role, "slide_copy": copy_text, "visual_direction": "v", "source_evidence": "E1", "slide_purpose": role, "media_need": None,
