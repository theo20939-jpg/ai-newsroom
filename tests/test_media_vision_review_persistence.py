...
MEDIA-PROD-1 (recovered PRODUCTION-SOURCE-RECONCILIATION-1): real-Postgres tests for
get_media_vision_review_calibration_summary() below (a fake session can't exercise a real select()
aggregation) - mirrors tests/test_image_persistence_m6.py's own db_session/real_news_event/
ImageCandidateRecord setup.
"""
