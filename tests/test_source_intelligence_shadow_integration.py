"""Phase 19 M8: proves source_intelligence_mode="shadow" cannot alter Copywriting's output -
mirrors tests/test_story_context_shadow_integration.py's exact established technique.
"""
...
async def test_shadow_mode_without_story_link_is_a_complete_noop(
    ...
    monkeypatch.setattr(settings, "source_intelligence_mode", "shadow")
