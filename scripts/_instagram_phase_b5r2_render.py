"""Phase B.5R.2: render the hero-object and collage reconstructions and record per-reconstruction diagnostics (no score).

Usage: python scripts/_instagram_phase_b5r2_render.py <out_dir>"""
